...
const Rating_Maggi = () => {
   ...
   const likefromlocal = JSON.parse(localStorage.getItem("lyk_maggi")) 
   const dislikefromlocal = JSON.parse(localStorage.getItem("dislyk_maggi"));
   ...
   function add_dislike(){
    ...
    useEffect(()=>{
        localStorage.setItem("lyk_maggi",JSON.stringify(like));
        localStorage.setItem("dislyk_maggi",JSON.stringify(dislike));
    },[like,dislike]);

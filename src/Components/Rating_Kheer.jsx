...
const Rating_Kheer = () => {
   ...
   const likefromlocal = JSON.parse(localStorage.getItem("lyk_kheer")) 
   const dislikefromlocal = JSON.parse(localStorage.getItem("dislyk_kheer"));
   ...
   function add_dislike(){
    ...
    useEffect(()=>{
        localStorage.setItem("lyk_kheer",JSON.stringify(like));
        localStorage.setItem("dislyk_kheer",JSON.stringify(dislike));
    },[like,dislike]);

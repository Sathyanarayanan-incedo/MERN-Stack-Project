...
const Rating_lassi = () => {
   ...
   const likefromlocal = JSON.parse(localStorage.getItem("lyk_lassi")) 
   const dislikefromlocal = JSON.parse(localStorage.getItem("dislyk_lassi"));
   ...
   function add_dislike(){
    ...
    useEffect(()=>{
        localStorage.setItem("lyk_lassi",JSON.stringify(like));
        localStorage.setItem("dislyk_lassi",JSON.stringify(dislike));
    },[like,dislike]);
